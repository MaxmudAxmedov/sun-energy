...
import { getClientsBusinessByIdQuery, getTradesQuery } from "@/quires/quires";
...
export default function ClientDrawerBusiness({
    isSheetOpen,
    setIsSheetOpen,
    row,
    selectedRowData,
    ...
    const { data: clients } = useQuery({
        ...getClientsBusinessByIdQuery(selectedRowData?.id),
        enabled: !!selectedRowData?.id,
    });
            ...
            action={
                <div className="flex justify-between items-center gap-3">
                    <Button
                        ...
                        onClick={() => navigate(`/createContract/${client.id}`)}
                    >
                        {t("contract")}
                    </Button>
                    <Button
                    ...
                    <CustomDeleteDialog
                        ...
                        mutateQueryKey={"client-businesses"}
        ...
        >
            <div className="p-3">
                <div className="flex gap-10">
                    <img
                        src={
                            forceConvertToNewDomain(client?.file) ||
                            client?.photo ||
                            OptionalImg
                        }
                        alt=""
