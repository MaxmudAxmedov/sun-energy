    ...
    <div className="h-screen">
      <div className="flex justify-between gap-3 mt-4">
        <Card className="w-[22%] text-center pt-4">
          ...
          <CardContent className="text-[22px]">{item?.count}</CardContent>
        </Card>
        <Card className="w-[22%] text-center pt-4">
          <CardTitle className="mb-2">Products</CardTitle>
          <CardContent className="text-[22px]">{totals.qty}</CardContent>
        </Card>
        <Card className="w-[22%] text-center pt-4">
        ...
        <Card className="w-[22%] text-center pt-4">
          ...
          <CardContent className="text-[22px]">{totals.kvt}</CardContent>
        </Card>
      </div>
