    ...
    >
      <div className="p-3">
        <div className="flex gap-10">
          <img
            src={employee?.data?.file || employee?.data?.photo || OptionalImg}
            alt=""
          ...
          <div>
            ...
            <NumberFormatter phone={employee?.data?.phone} fontSize={"22px"} />
            <h2 className="text-[20px] mt-2">
              {capitalize(employee?.data?.position_name)}
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 my-3">
              <div className="capitalize">{employee?.data?.region}</div>
              <div className="capitalize">{employee?.data?.district}</div>
              <div className="capitalize">{employee?.data?.quarter}</div>
              <div className="capitalize">{employee?.data?.street}</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-5">
            ...
            <div className="relative p-4 border dark:border-gray-600 rounded-md flex items-center justify-between">
              ...
              <p>
                <PriceFormater
                  price={employee?.data?.payments?.total_salary || 0}
                />
              </p>
              <p>UZS</p>
            </div>
